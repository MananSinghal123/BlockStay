    ...
    <div className="container w-[30rem] mx-auto bg-[#070B1E] px-4 py-8">
      <Card className="mb-8">
        <CardContent className="pt-6 text-white">
          <h2 className="text-2xl font-bold text-center mb-6 text-white">My Bookings</h2>
      ...
      <Card>
        <CardContent className="pt-6">
          <h2 className="text-2xl font-bold text-white text-center mb-6">Listings</h2>
          {/* <ListedNfts /> */}
          {nftsListed && nftsListed?.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground">No Room listed</p>
          )}
        </CardContent>
      </Card>
    </div>
