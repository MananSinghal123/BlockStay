import { getAllListingObjectAddresses, getListingObjectAndSeller, getListingObjectPrice } from "@/utils/aptos";
...
export const useGetListedNftsBySeller = (sellerAddr: string) => {
  ...
  //   useEffect(() => {
  //     getAllListingObjectAddresses(sellerAddr).then(async (listingObjectAddresses) => {
  //       const nfts = [];
