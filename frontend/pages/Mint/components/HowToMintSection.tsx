...
export const HowToMintSection: React.FC<HowToMintSectionProps> = () => {
  return (
    <section className="how-to-mint-container bg-black    px-4 text-center max-w-screen-xl mx-auto w-full">
      <h2 className="heading-md text-white">How to mint NFT</h2>
      ...
      <ol className="flex flex-col md:flex-row items-center md:justify-between pt-6 gap-6">
        {[
          ...
          <li key={index} className="flex items-center gap-4 basis-1/4">
            ...
            <p className="body-sm text-left text-white">{text}</p>
          </li>
        ))}
      </ol>
    </section>
